            ...
            <div id="multiStepForm">
                ...
                <asp:Panel runat="server" ID="pnlDirectorDetails" Visible="false">
                    <div id="step2" class="step">
                        <h2 class="text-2xl font-semibold text-[#06498e]  mb-6">Director Details</h2>
                        <div id="directorDetailsContainer">
                            <div class="directorDetail grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <label for="surname" class="block text-gray-700 font-semibold mb-0">Surname</label>
                                    <asp:TextBox ID="txtSurname" runat="server" CssClass="w-full px-3 py-2 border rounded" />
                                </div>
                                <div>
                                    <label for="givenName" class="block text-gray-700 font-semibold mb-0">Given Name</label>
                            ...
                            <div>
                                <label for="cardNumber" class="block text-gray-700 font-semibold mb-0">Card Number</label>
                                <asp:TextBox ID="txtCardNumber" TextMode="Number" runat="server" CssClass="w-full px-3 py-2 border rounded" />
                            </div>

                            <div>
                                <label for="nin" class="block text-gray-700 font-semibold mb-0">NIN</label>
                                <asp:TextBox ID="txtNIN" runat="server" CssClass="w-full px-3 py-2 border rounded" />
                            </div>

                            <div>
                                <label for="dob" class="block text-gray-700 font-semibold mb-0">Date Of Birth</label>
