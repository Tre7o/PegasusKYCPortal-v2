                    ...
                    <div class="">
                        ...
                        <asp:Panel class="flex flex-col gap-3" ID="pnlForm" Visible="True" runat="server">
                            <div class="mb-0">
                                ...
                                <asp:TextBox ID="txtUsername" Placeholder="Enter your username or email here.." runat="server" CssClass="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            </div>
                            <div class="mb-0">
                        ...
                        <asp:Panel class="flex flex-col gap-2" ID="pnlPasswordReset" Visible="false" runat="server">
                            <div class="">
                                ...
                                <asp:TextBox ID="txtResetEmail" runat="server" Placeholder="Enter your email or password here..." CssClass="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
